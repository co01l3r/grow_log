...
from records.utils import calculate_average_veg_temp


class CalculateAverageVegTempTestCase(TestCase):
    def setUp(self):
    ...
    def test_calculate_average_veg_temp_with_logs(self):
        avg_day_temp = calculate_average_veg_temp(self.cycle)
    ...
    def test_calculate_average_veg_temp_without_logs(self):
        ...
        avg_day_temp = calculate_average_veg_temp(cycle2)
